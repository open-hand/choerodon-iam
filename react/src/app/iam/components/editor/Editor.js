...
const CustomToolbar = ({ prefix }) => (
  <div id={`toolbar-${prefix}`}>
  ...
  render() {
    ...
    return (
      <div style={style} className="c7n-iam-react-quill-editor">
        ...
        />
        <ReactQuill
          id={`c7n-iam-editor-${prefix}`}
          theme="snow"
          modules={this.modules(prefix)}
          formats={this.formats}
          style={{ height: editHeight }}
          value={value}
          onChange={this.onQuillChange}
          bounds={`#c7n-iam-editor-${prefix}`}
