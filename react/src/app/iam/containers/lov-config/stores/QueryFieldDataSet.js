...
export default function ({ queryFieldTypeDs, booleanDs, queryFieldParamType }) {
  return {
    ...
    fields: [
      ...
      { name: 'queryFieldLookupCode', type: 'string', label: 'LookUp', lookupUrl: '/iam/choerodon/v1/lookups', textField: 'code', valueField: 'code' },
      { name: 'queryFieldLovCode', type: 'string', label: 'LOV', lookupUrl: '/iam/choerodon/v1/lov/list', textField: 'code', valueField: 'code' },
