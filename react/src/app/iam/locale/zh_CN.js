...
const pageDetail = {
  ...
  // 注册审批
  'register.approval.fields.username': '姓名',
  'register.approval.fields.useremail': '邮箱',
  'register.approval.fields.userphone': '手机',
  'register.approval.fields.orgname': '所在公司',
  'register.approval.fields.orgbusinesstype': '行业',
  'register.approval.fields.userorgposition': '角色',
  'register.approval.fields.orgscale': '公司规模',
  'register.approval.fields.orghomepage': '公司官网地址',
  'register.approval.no_approval': '待审批',
  'register.approval.approved': '通过',
  'register.approval.rejected': '不通过',

  // 平台层用户
  'global.user.button.assign-roles': '添加平台用户',
  'global.user.status': '状态',
  'global.user.safe-status': '安全状态',
  'global.user.action.enable': '启用',
  'global.user.action.disable': '停用',
  'global.user.action.unlock': '解锁',
  'global.user.action.lock': '锁定',
  'global.user.action.reset': '重置密码',
  'global.user.action.modify': '修改',
  'error.user.phone.exist': '手机号已存在',
  ...
  'global.root-user.sider.notfound.msg': '没有符合条件的结果',
  'global.root-user.sider.user': '用户',
  'global.root-user.list.action.delete': '删除',
  'global.root-user.sider.button.add': '添加其他用户',
  ...
  'organization.admin.list.button.add': '添加组织管理员',
  'organization.admin.list.action.delete': '删除',
  'organization.admin.sider.title': '添加组织管理员',
...
const zh_CN = {
  ...
  'global.organization.homepage.pattern.msg': '请输入正确的url格式',
  ...
  // 注册组织
  'register.organization.register.account': '申请注册',
  'register.organization.register.tip': '申请注册需要审核，请留下正确的注册信息，以便我们及时回复。',
  ...
  'register.organization.phone.used.msg': '该手机号已被使用',
  'register.organization.loginname': '账号',
  'register.organization.loginname.require.msg': '请输入账号',
  'register.organization.loginname.pattern.msg': '账号只能包含数字和字母',
  'register.organization.name.exist.msg': '已存在该账号，请输入其他账号',
  'register.organization.password': '密码',
  'register.organization.password.require.msg': '请输入密码',
  'register.organization.password.min.msg': '密码至少为{number}位',
  'register.organization.password.max.msg': '密码至多不能超过{number}位',
  'register.organization.organizationName.pattern.msg': '组织名只能由中文、大小写字母、数字、.、-、——和_构成',
  ...
  'register.organization.email.suffix.msg': '请务必填写公司邮箱，不接受个人邮箱',
  'register.organization.homepage': '请输入官网地址',
  'register.organization.homepage.pattern.msg': '请输入正确的url，由字母，数字和 . 组成，以http:// 或https:// 开始，以字母或数字结束',
  'register.organization.captcha': '验证码',
  'register.organization.captcha.require.msg': '请输入验证码',
  'register.organization.send.success': '发送成功，请检查邮件！',
  'register.organization.send.failed': '发送失败',
  'register.organization.send.captcha': '发送邮件验证码',
  'register.organization.send.retry.seconds': '重新获取({interval})',
  'register.organization.finish': '注册',
  'register.organization.already.have.account': '已有账号，点击快速登录',
  'register.organization.bg1.firstText': '任意应用，所有云一个平台',
  'register.organization.bg1.secondText': '敏捷化的应用交付，自动化的运营管理',
  'register.organization.bg2.firstText': '敏捷化的应用交付',
  'register.organization.bg2.secondText': '提高软件开发人员的工作效率，提升软件交付的质量內建以加速流程',
  'register.organization.bg3.firstText': '自动化的运营管理',
  'register.organization.bg3.secondText': '加速反馈速度，减少运维成本',
  'register.organization.agree': '请阅读并同意使用条款',
  'register.organization.submit.success': '您提交的注册信息正在审核，审核过程需要5分钟左右，审核结果会在第一时间发送至您的注册邮箱',
  'register.organization.submit.success.2': '请您进入邮箱查看审核结果。',
  'register.organization.register.organization': '注册组织',
  'register.organization.register.successful': '注册信息提交成功',
  'register.organization.congratulations': '注册信息已提交',
  'register.organization.register.failed': '注册失败',
  'register.organization.login': '点击登录',
  'register.organization.hint': '审核结果将通过邮件告知，请注意查收',
  'register.organization.name.require.msg': '请输入公司名称',
  'register.organization.username': '姓名',
  'register.organization.username.require.msg': '请输入姓名',
  'register.organization.name': '公司',
  'error.register.info.existed': '已经提交过注册信息，请等待审批',
  ...
  // 组织角色管理
  'organization.role.title': '组织"{name}"的角色管理',
  'organization.role.create': '创建角色',
  'organization.role.header.title': '角色管理',
  'organization.role.create.byone': '基于该角色创建',
  'organization.role.builtin.predefined': '预定义',
  'organization.role.builtin.custom': '自定义',
  ...
  'application.setting.creationDate': '创建时间',
  'application.setting.creator': '创建人',
  'application.setting.avatar': '应用Logo',
  'application.setting.avatar.edit.title': '上传应用图标',
  'application.setting.modal.title': '修改应用配置',
  'application.setting.namerequiredmsg': '请输入应用名称',
  'application.setting.name.pattern.msg': '应用名称只能由汉字、字母、数字、"_"、"."、"-"、"——"和空格组成',
  // 个人中心
  // 个人信息
  ...
  'user.userinfo.phone.used.msg': '该手机号已被使用，请输入其他手机号',
