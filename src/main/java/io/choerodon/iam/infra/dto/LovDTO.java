...
public class LovDTO extends AuditDomain {
    ...
    @Transient
    private List<io.choerodon.iam.infra.dto.LovQueryFieldDTO> queryFields;
    @Transient
    private List<io.choerodon.iam.infra.dto.LovGridFieldDTO> gridFields;
    ...
    public List<io.choerodon.iam.infra.dto.LovQueryFieldDTO> getQueryFields() {
        return queryFields;
    }

    public void setQueryFields(List<io.choerodon.iam.infra.dto.LovQueryFieldDTO> queryFields) {
        this.queryFields = queryFields;
    }

    public List<io.choerodon.iam.infra.dto.LovGridFieldDTO> getGridFields() {
        return gridFields;
    }

    public void setGridFields(List<io.choerodon.iam.infra.dto.LovGridFieldDTO> gridFields) {
