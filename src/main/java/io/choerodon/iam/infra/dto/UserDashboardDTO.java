...
public class UserDashboardDTO extends AuditDomain {
    ...
    @Transient
    private DashboardPositionVO positionVO;
    ...
    public DashboardPositionVO getPositionVO() {
        return positionVO;
    }

    public void setPositionVO(DashboardPositionVO positionVO) {
