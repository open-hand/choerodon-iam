...
databaseChangeLog(logicalFilePath: 'script/db/fd_organization.groovy') {
    ...
    changeSet(author: 'relaxingchu@qq.com', id: '2019-08-30-fd-organization-add-remote-token-enabled') {
        addColumn(tableName: 'FD_ORGANIZATION') {
            column(name: 'IS_REMOTE_TOKEN_ENABLED', type: 'TINYINT UNSIGNED', defaultValue: "1", remarks: '是否开启远程令牌连接功能。默认：1 开启; 0 关闭)', afterColumn: 'EMAIL_SUFFIX')
        }
    }
