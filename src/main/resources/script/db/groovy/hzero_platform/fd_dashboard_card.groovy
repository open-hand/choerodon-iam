...
databaseChangeLog(logicalFilePath: 'script/db/fd_dashboard_card.groovy') {
    changeSet(author: "jian.zhang02@hand-china.com", id: "fd_dashboard_card-2021-07-09-version-2") {
        createTable(tableName: "fd_dashboard_card", remarks: "面板卡片表") {
    ...
    changeSet(author: "jian.zhang02@hand-china.com", id: "fd_dashboard_card-2021-07-12-version-3") {
        dropColumn(tableName: "fd_dashboard_card", columnName: "link_service")
    }

    changeSet(author: "jian.zhang02@hand-china.com", id: "fd_dashboard_card-2021-07-12-version-4") {
        addColumn(tableName: "fd_dashboard_card") {
            column(name: "description", type: "VARCHAR(1000)", remarks: "描述", afterColumn: "card_name")
        }
        addColumn(tableName: "fd_dashboard_card") {
            column(name: "icon", type: "LONGTEXT", remarks: "图标", afterColumn: "max_h")
        }
    }
}
