...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_code_rule.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_code_rule") {
        ...
        createTable(tableName: "hpfm_code_rule", remarks: "编码规则头") {
            column(name: "rule_id", type: "bigint(20)", autoIncrement: true ,   remarks: "编码规则id ")  {constraints(primaryKey: true)} 
            ...
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "当应用层级为租户级时，此字段必输，值为租户id")  {constraints(nullable:"false")}  
