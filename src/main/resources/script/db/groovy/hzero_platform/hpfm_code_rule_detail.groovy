...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_code_rule_detail.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_code_rule_detail") {
        ...
        createTable(tableName: "hpfm_code_rule_detail", remarks: "编码规则明细") {
            column(name: "rule_detail_id", type: "bigint(20)", autoIncrement: true ,   remarks: "编码规则详情id ")  {constraints(primaryKey: true)} 
            column(name: "rule_dist_id", type: "bigint(20)",  remarks: "")  {constraints(nullable:"false")}  
            column(name: "order_seq", type: "int(11)",  remarks: "序号，决定编码规则生成的顺序")  {constraints(nullable:"false")}  
            ...
            column(name: "seq_length", type: "bigint(20)",  remarks: "位数")   
            column(name: "start_value", type: "bigint(20)",  remarks: "开始值")   
            column(name: "current_value", type: "bigint(20)",  remarks: "当前值")   
