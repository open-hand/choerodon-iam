...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_code_rule_dist.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_code_rule_dist") {
        ...
        createTable(tableName: "hpfm_code_rule_dist", remarks: "编码规则分配") {
            column(name: "rule_dist_id", type: "bigint(20)", autoIncrement: true ,   remarks: "编码规则分配id ")  {constraints(primaryKey: true)} 
            column(name: "rule_id", type: "bigint(20)",  remarks: "")  {constraints(nullable:"false")}  
            ...
            column(name: "used_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "")  {constraints(nullable:"false")}  
