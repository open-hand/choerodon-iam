...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_company.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_company") {
        ...
        createTable(tableName: "hpfm_company", remarks: "公司信息") {
            column(name: "company_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID")  {constraints(primaryKey: true)} 
            column(name: "company_num", type: "varchar(" + 30 * weight + ")",  remarks: "公司编码，自动生成")  {constraints(nullable:"false")}  
            column(name: "group_id", type: "bigint(20)",  remarks: "集团id")  {constraints(nullable:"false")}  
            column(name: "tenant_id", type: "bigint(20)",  remarks: "租户id，从集团带过来")  {constraints(nullable:"false")}  
            column(name: "unit_id", type: "bigint(20)",  remarks: "组织id")   
            column(name: "domestic_foreign_relation", type: "tinyint(1)",  remarks: "境内境外，IN境内，OUT境外")  {constraints(nullable:"false")}  
            ...
            column(name: "registered_country_id", type: "bigint(20)",  remarks: "国家")  {constraints(nullable:"false")}  
            column(name: "registered_region_id", type: "bigint(20)",  remarks: "地区id，树形值集")   
            ...
            column(name: "long_term_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "长期标志，1：长期，0：非长期")  {constraints(nullable:"false")}  
