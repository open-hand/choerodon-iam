...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_data_group_dtl.groovy') {
    changeSet(author: "jianbo.li@hanf-china.com", id: "2019-07-25-hpfm_data_group_dtl") {
        ...
        createTable(tableName: "hpfm_data_group_dtl", remarks: "数据组明细定义") {
            column(name: "group_dtl_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "group_line_id", type: "bigint(20)",  remarks: "数据组行ID")  {constraints(nullable:"false")}  
            column(name: "group_id", type: "bigint(20)",  remarks: "数据组ID")  {constraints(nullable:"false")}  
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID,hpfm_tenant.tenant_id")  {constraints(nullable:"false")}  
            column(name: "dtl_value_id", type: "bigint(20)",  remarks: "明细值ID，取自值集配置行ID")  {constraints(nullable:"false")}  
