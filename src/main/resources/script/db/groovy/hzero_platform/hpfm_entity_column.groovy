...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_entity_column.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com ", id: "2019-07-24-hpfm_entity_column") {
        ...
        createTable(tableName: "hpfm_entity_column", remarks: "实体列") {
            column(name: "entity_column_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "entity_table_id", type: "bigint(20)",  remarks: "实体表ID")  {constraints(nullable:"false")}  
            ...
            column(name: "pk_id_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否主键-@Id")  {constraints(nullable:"false")}  
            column(name: "pk_sequence_name", type: "varchar(" + 128 * weight + ")",  remarks: "序列名字-序列号生成器SequenceGenerator")   
            column(name: "pk_uuid_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "主键生成方式是否UUID方式")  {constraints(nullable:"false")}  
            column(name: "pk_identity_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "主键生成方式Identity方式")  {constraints(nullable:"false")}  
            column(name: "pk_generator", type: "varchar(" + 128 * weight + ")",  remarks: "主键生成器-GeneratedValue.generator/UUID/JDBC等")   
            column(name: "unique_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否唯一列")  {constraints(nullable:"false")}  
            column(name: "transient_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否非数据库字段")  {constraints(nullable:"false")}  
            column(name: "data_security_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否敏感字段")  {constraints(nullable:"false")}  
            column(name: "blob_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否Blob")  {constraints(nullable:"false")}  
            column(name: "lov_code", type: "varchar(" + 80 * weight + ")",  remarks: "LOV代码")   
            column(name: "multi_language_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否多语言字段")  {constraints(nullable:"false")}  
            column(name: "remark", type: "longtext",  remarks: "备注说明")   
            column(name: "deleted_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "删除标识，0-未删除，1-已删除")  {constraints(nullable:"false")}  
