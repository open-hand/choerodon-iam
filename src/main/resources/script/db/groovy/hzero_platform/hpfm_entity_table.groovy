...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_entity_table.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com ", id: "2019-07-24-hpfm_entity_table") {
        ...
        createTable(tableName: "hpfm_entity_table", remarks: "实体表") {
            column(name: "entity_table_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "multi_language_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否多语言表")  {constraints(nullable:"false")}  
            column(name: "multi_language_unique_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否存在多语言字段作为唯一性字段")  {constraints(nullable:"false")}  
