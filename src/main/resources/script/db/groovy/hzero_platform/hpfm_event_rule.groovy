...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_event_rule.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_event_rule") {
        ...
        createTable(tableName: "hpfm_event_rule", remarks: "事件规则表 ") {
            column(name: "event_rule_id", type: "bigint(20)", autoIncrement: true ,   remarks: "主键ID ")  {constraints(primaryKey: true)} 
            column(name: "event_id", type: "bigint(20)",  remarks: "事件ID")  {constraints(nullable:"false")}  
            ...
            column(name: "order_seq", type: "int(11)",   defaultValue:"1",   remarks: "调用顺序")  {constraints(nullable:"false")}  
            column(name: "matching_rule", type: "varchar(" + 500 * weight + ")",  remarks: "匹配规则，OGNL表达式")  {constraints(nullable:"false")}  
            column(name: "result_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "同步调用是否返回结果 1：返回；0：不反悔；默认1；")  {constraints(nullable:"false")}  
