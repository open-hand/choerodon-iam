...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_form_line.groovy') {
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2019-07-11-hpfm_form_line") {
        ...
        createTable(tableName: "hpfm_form_line", remarks: "表单配置行") {
            column(name: "form_line_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)}
            column(name: "form_header_id", type: "bigint(20)", remarks: "表单配置头表")  {constraints(nullable:"false")}
            ...
            column(name: "order_seq", type: "bigint(20)", remarks: "排序号")  {constraints(nullable:"false")}
            column(name: "item_type_code", type: "varchar(" + 30 * weight + ")", remarks: "配置类型，HPFM.ITEM_TYPE")  {constraints(nullable:"false")}
            column(name: "required_flag", type: "tinyint(1)", defaultValue: "0",remarks: "是否必输 1:必输 0：不必输")  {constraints(nullable:"false")}
            column(name: "default_value", type: "varchar(" + 255 * weight + ")", remarks: "默认值")
            column(name: "enabled_flag", type: "tinyint(1)", defaultValue: "1",remarks: "是否启用 1:启用 0：不启用")  {constraints(nullable:"false")}
    ...
    changeSet(author: "fanghan.liu@hand-china.com", id: "2020-01-03-hpfm_form_line") {
        ...
        addColumn(tableName: 'hpfm_form_line') {
            column(name: "updatable_flag", type: "tinyint(1)", defaultValue: "1", remarks: "是否允许更新") {constraints(nullable:"false")}
        }
        addColumn(tableName: 'hpfm_form_line') {
