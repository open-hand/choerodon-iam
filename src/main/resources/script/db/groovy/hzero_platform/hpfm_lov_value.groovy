...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_lov_value.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_lov_value") {
        ...
        createTable(tableName: "hpfm_lov_value", remarks: "LOV独立值集表") {
            column(name: "lov_value_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "lov_id", type: "bigint(20)",  remarks: "lov表Id")  {constraints(nullable:"false")}  
            ...
            column(name: "enabled_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "生效标识：1:生效，0:失效")  {constraints(nullable:"false")}  
