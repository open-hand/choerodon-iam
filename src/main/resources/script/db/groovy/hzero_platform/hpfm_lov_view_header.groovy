...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_lov_view_header.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_lov_view_header") {
        ...
        createTable(tableName: "hpfm_lov_view_header", remarks: "值集查询视图头表") {
            column(name: "view_header_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键 ")  {constraints(primaryKey: true)} 
            ...
            column(name: "width", type: "int(11)",  remarks: "宽度")   
            column(name: "height", type: "int(11)",  remarks: "高度")   
            column(name: "page_size", type: "int(11)",   defaultValue:"10",   remarks: "分页大小 ")  {constraints(nullable:"false")}  
            column(name: "delay_load_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否延迟加载 ")  {constraints(nullable:"false")}  
