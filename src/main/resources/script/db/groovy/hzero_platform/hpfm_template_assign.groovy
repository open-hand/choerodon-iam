...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_template_assign.groovy') {
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2019-07-01-hpfm_template_assign") {
        ...
        createTable(tableName: "hpfm_template_assign", remarks: "模板配置") {
            column(name: "template_assign_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键，供其他表做外键") {
            ...
            column(name: "template_id", type: "bigint(20)", remarks: "模板Id，hpfm_template.template_id") { constraints(nullable: "false") }
            column(name: "tenant_id", type: "bigint(20)", remarks: "租户Id") {
                constraints(nullable: "false")
            }
            column(name: "default_flag", type: "tinyint(1)", defaultValue: "0", remarks: "默认标识 1:默认 0:非默认") {
                constraints(nullable: "false")
            }
