...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_template_config.groovy') {
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2019-06-27-hpfm_template_config") {
        ...
        createTable(tableName: "hpfm_template_config", remarks: "模板配置") {
            column(name: "config_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键，供其他表做外键") {
                constraints(primaryKey: true)
            }
            column(name: "template_assign_id", type: "bigint(20)", remarks: "模板配置ID，hpfm_template_assign.template_assign_id") {
            ...
            column(name: "order_seq", type: "int(11)", remarks: "排序标识，用于为配置排序")
            column(name: "tenant_id", type: "bigint(20)", defaultValue: "0", remarks: "租户ID,hpfm_tenant") {
                constraints(nullable: "false")
            }
