...
databaseChangeLog(logicalFilePath: 'script/db/hiam_doc_type.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hiam_doc_type") {
        ...
        createTable(tableName: "hiam_doc_type", remarks: "单据类型定义") {
            column(name: "doc_type_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "rule_id", type: "bigint(20)",  remarks: "数据屏蔽规则ID，创建数据屏蔽规则后，反写，HPFM_PERMISSION_RULE.RULE_ID")   
