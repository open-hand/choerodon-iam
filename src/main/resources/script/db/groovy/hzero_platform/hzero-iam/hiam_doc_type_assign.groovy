...
databaseChangeLog(logicalFilePath: 'script/db/hiam_doc_type_assign.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hiam_doc_type_assign") {
        ...
        createTable(tableName: "hiam_doc_type_assign", remarks: "单据类型分配") {
            ...
            column(name: "doc_type_id", type: "bigint(20)",  remarks: "单据类型ID，HIAM_DOC_TYPE.DOC_TYPE_ID")  {constraints(nullable:"false")}  
            column(name: "assign_value_id", type: "bigint(20)",  remarks: "分配值ID，当前level_code=TENANT，则此处为租户ID，HPFM_TENANT.TENANT_ID")  {constraints(nullable:"false")}  
