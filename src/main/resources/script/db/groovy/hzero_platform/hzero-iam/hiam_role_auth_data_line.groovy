...
databaseChangeLog(logicalFilePath: 'script/db/hiam_role_auth_data_line.groovy') {
    changeSet(author: "qingsheng.chen@hand-china.com", id: "2019-06-14-hiam_role_auth_data_line") {
        ...
        createTable(tableName: "hiam_role_auth_data_line", remarks: "角色单据权限管理行") {
            column(name: "auth_data_line_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "auth_data_id", type: "bigint(20)",  remarks: "权限ID，hiam_role_auth_data.auth_data_id")  {constraints(nullable:"false")}  
