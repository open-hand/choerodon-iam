...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_acl.groovy') {
    changeSet(author: "hzero", id: "2020-03-13-hiam_sec_grp_acl") {
        ...
        createTable(tableName: "hiam_sec_grp_acl", remarks: "安全组访问权限") {
            column(name: "sec_grp_acl_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "permission_id", type: "bigint(20)",  remarks: "访问权限ID")  {constraints(nullable:"false")}  
