...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_assign.groovy') {
    changeSet(author: "hzero", id: "2020-03-13-hiam_sec_grp_assign") {
        ...
        createTable(tableName: "hiam_sec_grp_assign", remarks: "安全组分配关系") {
            column(name: "user_sec_grp_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "dimension_value", type: "bigint(20)",  remarks: "维度值[USER(用户ID),ROLE(角色ID)]")  {constraints(nullable:"false")}  
            column(name: "sec_grp_id", type: "bigint(20)",  remarks: "安全组ID,hiam_sec_grp.sec_grp_id")  {constraints(nullable:"false")}  
