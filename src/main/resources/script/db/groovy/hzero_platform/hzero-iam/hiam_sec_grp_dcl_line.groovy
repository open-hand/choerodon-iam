...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_dcl_line.groovy') {
    changeSet(author: "hzero", id: "2020-03-13-hiam_sec_grp_dcl_line") {
        ...
        createTable(tableName: "hiam_sec_grp_dcl_line", remarks: "安全组数据权限行") {
            column(name: "sec_grp_dcl_line_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "sec_grp_dcl_id", type: "bigint(20)",  remarks: "安全组数据权限ID")  {constraints(nullable:"false")}  
