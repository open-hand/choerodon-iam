...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_revoke.groovy') {
    changeSet(author: "hzero", id: "2020-03-13-hiam_sec_grp_revoke") {
        ...
        createTable(tableName: "hiam_sec_grp_revoke", remarks: "安全组权限回收") {
            column(name: "sec_grp_revoke_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "authority_id", type: "bigint(20)",  remarks: "安全组权限ID")  {constraints(nullable:"false")}  
            column(name: "shield_role_id", type: "bigint(20)",  remarks: "屏蔽角色ID")   
