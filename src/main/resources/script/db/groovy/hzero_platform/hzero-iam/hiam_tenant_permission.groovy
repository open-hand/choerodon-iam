...
databaseChangeLog(logicalFilePath: 'script/db/hiam_tenant_permission.groovy') {
    ...
    changeSet(author: "hzero@hand-china.com", id: "2019-11-26-hiam_tenant_permission") {
        ...
        createTable(tableName: "hiam_tenant_permission", remarks: "租户权限") {
			column(name: "tenant_permission_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "tenant_id", type: "bigint(20)", remarks: "租户ID，hpfm_tenant.tenant_id")  {constraints(nullable:"false")}  
			column(name: "permission_id", type: "bigint(20)", remarks: "权限ID，iam_permission.id")  {constraints(nullable:"false")}  
