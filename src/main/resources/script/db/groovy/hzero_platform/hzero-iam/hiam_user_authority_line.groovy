...
databaseChangeLog(logicalFilePath: 'script/db/hiam_user_authority_line.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hiam_user_authority_line") {
        ...
        createTable(tableName: "hiam_user_authority_line", remarks: "用户权限管理行") {
            column(name: "authority_line_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "authority_id", type: "bigint(20)",  remarks: "权限ID，HIAM_USER_AUTHORITY.AUTHORITY_ID")  {constraints(nullable:"false")}  
