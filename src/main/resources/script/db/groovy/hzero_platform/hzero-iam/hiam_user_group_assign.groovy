...
databaseChangeLog(logicalFilePath: 'script/db/hiam_user_group_assign.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hiam_user_group_assign") {
        ...
        createTable(tableName: "hiam_user_group_assign", remarks: "用户组分配") {
            ...
            column(name: "user_id", type: "bigint(20)",  remarks: "用户ID，iam_user.user_id")   
            column(name: "user_group_id", type: "bigint(20)",  remarks: "hiam_user_group.user_group_id")   
            column(name: "default_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否默认 1:默认 0:不默认")  {constraints(nullable:"false")}  
