...
databaseChangeLog(logicalFilePath: 'script/db/hiam_user_info.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hiam_user_info") {
        ...
        createTable(tableName: "hiam_user_info", remarks: "用户信息表") {
            column(name: "user_id", type: "bigint(20)",  remarks: "表ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "employee_id", type: "bigint(20)",  remarks: "员工id")   
            column(name: "text_id", type: "bigint(20)",  remarks: "协议id")   
            ...
            column(name: "user_source", type: "tinyint(1)",   defaultValue:"0",   remarks: "用户来源：0-由管理员创建，1-门户注册")  {constraints(nullable:"false")}  
            column(name: "phone_check_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "手机是否已验证")  {constraints(nullable:"false")}  
            column(name: "email_check_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "邮箱是否已验证")  {constraints(nullable:"false")}  
            column(name: "password_reset_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "密码是否需要重置")  {constraints(nullable:"false")}  
            column(name: "default_tenant_id", type: "bigint(20)",  remarks: "默认租户ID,hpfm_tenant.tenant_id")   
            ...
            column(name: "gender", type: "tinyint(1)",  remarks: "性别, 1: 男 0: 女")   
            column(name: "country_id", type: "bigint(20)",  remarks: "国家")   
            column(name: "region_id", type: "bigint(20)",  remarks: "地区id，树形值集")   
