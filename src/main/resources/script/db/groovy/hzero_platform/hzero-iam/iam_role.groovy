...
databaseChangeLog(logicalFilePath: 'script/db/iam_role.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-iam_role") {
        ...
        createTable(tableName: "iam_role", remarks: "") {
            ...
            column(name: "h_tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "所属租户ID")   
            column(name: "h_inherit_role_id", type: "bigint(20)",   defaultValue:"0",   remarks: "继承角色ID")   
            column(name: "h_parent_role_id", type: "bigint(20)",   defaultValue:"0",   remarks: "父级角色ID")   
            column(name: "h_parent_role_assign_level", type: "varchar(" + 20 * weight + ")",  remarks: "父级角色分配层级")   
            column(name: "h_parent_role_assign_level_val", type: "bigint(20)",  remarks: "父级角色分配值")   
            column(name: "is_enabled", type: "tinyint(3)",   defaultValue:"1",   remarks: "是否启用。1启用，0未启用")  {constraints(nullable:"false")}  
            column(name: "is_modified", type: "tinyint(3)",   defaultValue:"1",   remarks: "是否可以修改。1表示可以，0不可以")  {constraints(nullable:"false")}  
            column(name: "is_enable_forbidden", type: "tinyint(3)",   defaultValue:"1",   remarks: "是否可以被禁用")  {constraints(nullable:"false")}  
            column(name: "is_built_in", type: "tinyint(3)",   defaultValue:"0",   remarks: "是否内置。1表示是，0表示不是")  {constraints(nullable:"false")}  
            column(name: "is_assignable", type: "tinyint(3)",   defaultValue:"1",   remarks: "是否禁止在更高的层次上分配，禁止project role在organization上分配。1表示可以，0表示不可以")  {constraints(nullable:"false")}  
	...
	changeSet(author: 'jiangzhou.bo@hand-china.com', id: '2019-08-12-iam_role') {
        addColumn(tableName: 'iam_role') {
            column(name: 'created_by_tenant_id',  type: 'bigint(20)', remarks: '创建者租户ID')
        }
