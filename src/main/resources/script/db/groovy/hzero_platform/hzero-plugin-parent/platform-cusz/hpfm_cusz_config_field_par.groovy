...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_cusz_config_field_par.groovy') {
    changeSet(author: "peng.yu01@hand-china.com", id: "2020-02-25_hpfm_cusz_config_field_par") {
        ...
        createTable(tableName: "hpfm_cusz_config_field_par") {
            column(name: "config_field_par_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键，供其他表做外键") {
                constraints(primaryKey: true)
            }
            column(name: "tenant_id", type: "bigint(20)", remarks: "租户ID") {
                constraints(nullable: false)
            }
            column(name: "config_field_id", type: "bigint(20)", remarks: "字段id，hpfm_cusz_config_field.config_field_id") {
                constraints(nullable: false)
            }
