...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_cusz_unit_field_par.groovy') {
    changeSet(author: "peng.yu01@hand-china.com", id: "2020-02-25_hpfm_cusz_unit_field_par") {
        def weight = 1
        ...
        addUniqueConstraint(columnNames: "unit_field_id,param_key,tenant_id", tableName: "hpfm_cusz_unit_field_par", constraintName: "hpfm_cusz_unit_field_par_U1")
    }
}
