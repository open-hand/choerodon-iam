...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_employee_assign.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_employee_assign") {
        ...
        createTable(tableName: "hpfm_employee_assign", remarks: "员工岗位分配表") {
            column(name: "employee_assign_id", type: "bigint(20)", autoIncrement: true ,   remarks: "员工岗位分配ID　")  {constraints(primaryKey: true)} 
            column(name: "employee_id", type: "bigint(20)",  remarks: "员工ID")  {constraints(nullable:"false")}  
            ...
            column(name: "primary_position_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "主岗位标示")  {constraints(nullable:"false")}  
            ...
            column(name: "object_version_number", type: "bigint(20)",   defaultValue:"1",   remarks: "记录版本号")  {constraints(nullable:"false")}  
