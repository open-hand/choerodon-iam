...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_hr_sync_dept_employee.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-12-27-hpfm_hr_sync_dept_employee") {
        ...
        createTable(tableName: "hpfm_hr_sync_dept_employee", remarks: "HR数据同步员工分配岗位") {
            column(name: "sync_assign_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "sync_dept_id", type: "bigint(20)",  remarks: "同步数据部门ID")  {constraints(nullable:"false")}  
            column(name: "sync_employee_id", type: "bigint(20)",  remarks: "同步数据员工ID")  {constraints(nullable:"false")}  
