...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_hr_sync_log.groovy') {
    changeSet(author: "minghui.qiu@hand-china.com", id: "2019-10-15-hpfm_hr_sync_log") {
        ...
        createTable(tableName: "hpfm_hr_sync_log", remarks: "hr基础数据同步外部系统日志") {
            column(name: "sync_log_id", type: "bigint(20)", autoIncrement: true ,   remarks: "主键")  {constraints(primaryKey: true)}
            column(name: "sync_id", type: "bigint(20)",  remarks: "基础数据同步配置hpfm_hr_sync.sync_id")  {constraints(nullable:"false")}  
            column(name: "dept_status_code", type: "tinyint(1)",   defaultValue:"0",   remarks: "部门同步状态")  {constraints(nullable:"false")}
            column(name: "emp_status_code", type: "tinyint(1)",   defaultValue:"0",   remarks: "员工同步状态")  {constraints(nullable:"false")}  
