...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_search.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-03-10-hpfm_search") {
        ...
        createTable(tableName: "hpfm_search", remarks: "高级检索配置") {
            column(name: "search_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "default_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "默认高级检索配置标记")  {constraints(nullable:"false")}  
