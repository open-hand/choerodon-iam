...
//        entity.getBody()
    ...
    def "assignRoles"() {
        ...
        clientDTO.setOrganizationId(1L)
        clientDTO.setName("name123")
        ...
        when:"非法角色"
        controller.assignRoles(1L, clientId, Arrays.asList(1L))

        then:
        def e = thrown(CommonException)
        e.getMessage()=="error.client.illegal.role.id"

        when:"合法角色"
        controller.assignRoles(1L, clientId, Arrays.asList(4L))
        then:
        noExceptionThrown()
    }
}
