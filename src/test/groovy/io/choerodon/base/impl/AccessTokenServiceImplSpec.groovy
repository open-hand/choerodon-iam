...
import io.choerodon.base.infra.dto.RefreshTokenDTO
...
class AccessTokenServiceImplSpec extends Specification {
    ...
    def "pagedSearch"() {
        ...
        when:
        def entity = accessTokenService.pagedSearch(pageRequest, "client", "9574c75-e00f-463e-b376-4d1f961acade", null)
